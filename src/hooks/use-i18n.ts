...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'menu.about': 'About',
    'menu.aboutText': 'Includes wisdom from Marcus Aurelius, Epictetus, and other great thinkers.',
  ...
  ru: {
    ...
    'menu.aboutText': 'Включает мудрость Марка Аврелия, Эпиктета и других великих мыслителей.',
  ...
  zh: {
    ...
    'menu.zenMode': '禅模式',
    'menu.about': '关于',
    'menu.aboutText': '包含马可·奥勒留、爱比克泰德和其他伟大思想家的智慧。',
    'menu.controls': '控制',
  ...
  he: {
    ...
    'menu.zenMode': 'מצב זן',
    'menu.about': 'אודות',
    'menu.aboutText': 'כולל חוכמה של מרקוס אורליוס, אפיקטטוס והוגים דגולים נוספים.',
    'menu.controls': 'בקרות',
