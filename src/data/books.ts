...
const marcusAureliusQuotes: Quote[] = [
  ...
  { text: "Лучший способ отомстить врагу — не уподобляться ему.", author: "Марк Аврелий", era: "Античность", category: "мудрость" },
...
const senecaQuotes: Quote[] = [
  ...
  { text: "Тот, кто не знает, куда направляется, очень удивится, попав не туда.", author: "Сенека", era: "Античность", category: "цель" },
