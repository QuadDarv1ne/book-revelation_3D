...
const marcusAureliusQuotes: Quote[] = [
  ...
  { text: "Ты имеешь власть над своим умом — не над внешними событиями. Осознай это, и ты обретёшь силу.", author: "Марк Аврелий", era: "Античность" },
  { text: "Всё, что мы слышим, — мнение, а не факт. Всё, что мы видим, — перспектива, а не истина.", author: "Марк Аврелий", era: "Античность" },
  { text: "Не позволяй будущему тревожить тебя. Ты встретишь его, если придётся, с тем же оружием разума, которое вооружает тебя против настоящего.", author: "Марк Аврелий", era: "Античность" },
];
...
const epictetusQuotes: Quote[] = [
  ...
  { text: "Нет человека, который был бы свободен, если он не владеет собой.", author: "Эпиктет", era: "Античность" },
  { text: "Богатство не в том, чтобы иметь много, а в том, чтобы желать мало.", author: "Эпиктет", era: "Античность" },
  { text: "Стойкость — это не отсутствие чувств, а правильная реакция на них.", author: "Эпиктет", era: "Античность" },
];
...
const senecaQuotes: Quote[] = [
  ...
  { text: "Жизнь длинна, если ты умеешь ею пользоваться.", author: "Сенека", era: "Античность" },
  { text: "Трудности укрепляют дух, как труд укрепляет тело.", author: "Сенека", era: "Античность" },
  { text: "Время — самая ценная вещь, которую может потратить человек.", author: "Сенека", era: "Античность" },
];
...
const sunTzuQuotes: Quote[] = [
  ...
  { text: "Победа приходит к тем, кто готов ждать.", author: "Сунь-цзы", era: "Древний Китай" },
  { text: "Кто не знает, когда можно сражаться, а когда нельзя, тот проиграет.", author: "Сунь-цзы", era: "Древний Китай" },
  { text: "Быстрота — сущность войны.", author: "Сунь-цзы", era: "Древний Китай" },
];
...
const hawkingQuotes: Quote[] = [
  ...
  { text: "Каким бы трудным ни казался жизнь, всегда есть что-то, что вы можете сделать и в чём преуспеть.", author: "Стивен Хокинг", era: "Современность" },
  { text: "Вселенная начинается с нас. Мы — способ Вселенной познать саму себя.", author: "Стивен Хокинг", era: "Современность" },
  { text: "Тихие люди имеют самый громкий ум.", author: "Стивен Хокинг", era: "Современность" },
];
